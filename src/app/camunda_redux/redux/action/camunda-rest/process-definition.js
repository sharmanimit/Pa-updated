...
export const postProcessInstanceVariables = (id) => ({
    [CALL_API]: {
        types: [ AT.NEW_PROCESS_INSTANCE_VARIABLES_REQUEST, AT.NEW_PROCESS_INSTANCE_VARIABLES_SUCCESS, AT.NEW_PROCESS_INSTANCE_VARIABLES_FAILURE ],
        endpoint: `process-instance/${id}/variables`,
        settings: {
            method: 'get'
        }
    }
