...
const root_url = sessionStorage.getItem("proxy_url")

const API_ROOT = '/camunda/engine-rest/'

// Fetches an API response and normalizes the result JSON according to schema.
// This makes every API res ponse have the same shape, regardless of how nested it was.
...
const formKeySchema = new schema.Entity('formKey', {}, {
  idAttribute: formKey => formKey.id,
  name: formKey => formKey.name
});
