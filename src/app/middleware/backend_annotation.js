...
const API_ROOT = '/annotation_service';
...
export const BACK_ANNOTATION_API = 'Back Annotation API';

export default store => next => action => {

    const callAPI = action[BACK_ANNOTATION_API]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACK_ANNOTATION_API]
        return finalAction
    }
