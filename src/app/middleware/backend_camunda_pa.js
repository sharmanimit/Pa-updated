const API_ROOT = '/workflow-gateway';
...
export const BACK_CAMUNDA_PA_API = 'Back Camunda PA API';

export default store => next => action => {

    const callAPI = action[BACK_CAMUNDA_PA_API]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACK_CAMUNDA_PA_API]
        return finalAction
    }
