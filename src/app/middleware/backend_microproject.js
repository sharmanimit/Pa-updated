...
export const BACK_MICROPROJECT_API = 'Back Micro Project API';

export default store => next => action => {

    const callAPI = action[BACK_MICROPROJECT_API]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACK_MICROPROJECT_API]
        return finalAction
    }
