...
const API_ROOT = '/personal_info_service';
...
export const BACK_PERSONAL_INFO_API = 'Back Personal Info API';

export default store => next => action => {

    const callAPI = action[BACK_PERSONAL_INFO_API]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACK_PERSONAL_INFO_API]
        return finalAction
    }
