...
const API_ROOT = '/retrieval_service';
...
export const BACK_RETRIEVAL_API = 'Back Retrieval API';

export default store => next => action => {

    const callAPI = action[BACK_RETRIEVAL_API]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACK_RETRIEVAL_API]
        return finalAction
    }
