...
export const BACK_USER_MANAGEMENT_API = 'Back User Management API';

export default store => next => action => {

    const callAPI = action[BACK_USER_MANAGEMENT_API]
    ...
    const actionWith = data => {
        ...
        delete finalAction[BACK_USER_MANAGEMENT_API]
        return finalAction
    }
